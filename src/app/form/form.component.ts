...
export class FormComponent implements OnInit {
  ...
  submitForm(form: any) {
    this.complaint = {
      id: 0, domain: form.value.domain, subject: form.value.subject, description: form.value.description,
      isAnonymous: +form.value.privacy, rollno: sessionStorage.getItem('rollno'), likes: 0, isResolved: 0
    };
